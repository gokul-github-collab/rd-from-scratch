...
const AddSubject = () => {
    ...
    const [semester, setSemester] = useState(onesemester? onesemester.id: "")
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        const createSubject = {
            name, course_code, semester: onesemester? onesemester.id: "", ltpc, prerequisite, external_mark, internal_mark
        }
