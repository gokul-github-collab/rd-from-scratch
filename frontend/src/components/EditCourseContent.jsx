...
const EditCourseContent = () => {
    ...
    const handleSubmit = (e) => {
        ...
        api.put(`/api/course-content/${id}/`, editCourseContent)
            .then((res) => {
                toast('Course Content updated successfully');
        ...
        <>
            ...
            {isSuperUser ? <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-indigo-600 sm:text-4xl">Edit Course Content</h2>
