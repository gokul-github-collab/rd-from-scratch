...
const AddSemester = () => {
    ...
    const [oneSyllabus, setOneSyllabus] = useState(null)
    ...
    const getCourse = (courseId) => {
        ...
        const getSyllabus = (id) => {
            ...
            then((res)=> setOneSyllabus(res.data)). 
    ...
    const handleSubmit = (e) => {
        ...
        const createSemester = {
            title,
            course: onecourse? onecourse.id: "",
            syllabus: oneSyllabus? oneSyllabus.id: ""
        };
    
        api.post(`/api/semester/`, createSemester)
            .then((res) => {
                toast.success('Semester created successfully');
                navigate(`/syllabus/${sid}`);
            })
            .catch((err) => toast.error(err));
    };
  ...
  return (
   ...
   {isSuperUser ?  <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-indigo-600 sm:text-4xl">Add Semester</h2>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <input
                ...
                name="syllabus"
                id="syllabus"
                value={oneSyllabus ? oneSyllabus.year: ""}
                readOnly
                className="block w-full cursor-not-allowed pointer-events-none  rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
