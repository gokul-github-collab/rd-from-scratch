...
const EditCourseObjective = () => {
    ...
    const handleSubmit = (e) => {
        ...
        api.put(`/api/course-objective/${id}/`, editCourseObjectives)
            .then((res) => {
                toast('Course Objective updated successfully');
                navigate(`/subject/${cob.subject}`);
            })
            .catch((err) => toast.error(err));
    };
        ...
        <>
            ...
            {isSuperUser ? <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-indigo-600 sm:text-4xl">Edit Course Objectives (CO's)</h2>
...
export default EditCourseObjective